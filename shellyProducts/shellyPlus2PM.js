...
class ShellyPlus2PMRoller extends ShellyMaster {
    static getRollerPosition() {
        if (this.lastStatus == null) return null;
        return this.lastStatus['cover:0'].current_pos;
    }
    static getPowerConsumption() {
        if (this.lastStatus == null) return null;
        return this.lastStatus['cover:0'].apower;
    }
    static getRollerState() {
        if (this.lastStatus == null) return null;
        return this.lastStatus['cover:0'].state;
    }
...
class ShellyPlus2PMRelay extends ShellyMaster {
...
export { ShellyPlus2PMRelay, ShellyPlus2PMRoller };